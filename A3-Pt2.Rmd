...
1.  Hurricanes plots over time -\> Making Hurricane plots to see if there are changes during COVID time.

2.  Hurricane category facet by time -\> If there is a significant change when COVID tend change.

3.  Ice melting speed vs the number of cases in COVID -\> covid 19, isolation makes people sad of course, but we also think that there might be an extreme at the very end (there's people that's actually happy)

    These are the dataset we gonna use: Hurricane, covid-19, Ice_extent
