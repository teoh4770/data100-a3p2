...
The next steps in this analysis are collecting more useful data sets such as carbon emission level [^2] and earth temperature. By analyzing the relationship between COVID and these data set, we can get more significant insights about this topic.
...
[^3]: Original covid_2020 dataset. URL: https://covid.ourworldindata.org/

[^4]: Original sea_ice_extent dataset.

[^5]: Original cyclones_data dataset.
